...
/**
 * This is the model class for table "groupon_subject".
 *
 * The followings are the available columns in table 'groupon_subject':
 * @property integer $id
 * @property string $name
 * @property integer $pid
 * @property integer $created
 */
class GrouponSubjectModel extends CActiveRecord {
    ...
    Public function get_all_sub_category($id) {
        ...
        $model = GrouponSubjectModel::model()->findAll('pid=:id', array(':id' => $id));
        if ($model > 0) {
            foreach ($model as $v) {
                GrouponSubjectModel::model()->get_all_sub_category($v->id);
            }
        }
    ...
    public function rules() {
        ...
        return array(
            array('pid, created, is_hot', 'numerical', 'integerOnly' => true),
     ...
     * @return GrouponSubjectModel the static model class
     */
