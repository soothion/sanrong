 ...
 *
 * The followings are the available columns in table 'user_train':
 * @property integer $id
 ...
 */
class UserTrainModel extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('organization_name, major', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, resume_id, from_time, to_time, organization_name, major, gain, created', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return UserTrainModel the static model class
	 */
