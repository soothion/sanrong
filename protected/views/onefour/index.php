    ...
    <div class="search_box">
        ...
        <div class="selbox sortbox">
            ...
            <ul>
                ...
                <?php foreach ($groupon_category as $k => $v): ?>
                    <li><a  href="javascript:goods_filter(<?php echo $v->id ?>,0)"><?php echo $v->name; ?></a></li>
                <?php endforeach; ?>
            </ul>
        ...
        <div class="selbox areabox">
            ...
            <ul>
                ...
                <li><a  href="javascript:goods_filter(<?php echo $v->id ?>,2)" ><?php echo $v->name ?></a></li>
                <?php endforeach; ?>
            </ul>
                    ...
                    <li>
                        <div class="deal_outer">
                            ...
                            <div class="deal_price">
                                <div class="price"> <span class="symbol">￥</span><?php echo numeric($v->g_price) ?> <span class="value">价值<span class="symbol">￥</span><?php echo ($v->m_price) ?></span></div>
