...
<div class='main'>
    ...
    <div class="search_box"> 
        ...
        <div class="resultbox">
            <h5>排序：</h5>
            <div class="order"> <a href="<?php echo $default_order_url ?>" class="default default_on">默认</a><a href="<?php echo $sales_order_url ?>" class="sales">销量</a><a href="<?php echo $discount_order_url ?>" class="discount">折扣</a>  </div>
        </div>
        <!--结果排序结束--> 
                ...
                <?php foreach ($groupo_goods as $k => $v): ?>
                    <li>
                        <div class="deal_outer">
                            ...
                            <div class="deal_people"> <span class="people"><span class="num">
                                        <?php echo GrouponGoodsModel::model()->get_salenum($v->id) ?>
                                    </span>人购买</span></div>
                        </div>
                    </li>
                <?php endforeach; ?>
