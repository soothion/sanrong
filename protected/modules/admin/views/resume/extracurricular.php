...
<div class="tab">
    ...
    <a  class="on" href="javascript:;">课外经历</a>
</div>
<div class="resume_list">
    ...
    <?php endif; ?>
    <table>
        <tr <?php if (array_key_exists('extracurricular', $resume_log_content)): ?> class="<?php echo $resume_log_content['extracurricular']['color'] ?>" <?php endif ?>>
            <td>课外经历：</td>
            <td>
