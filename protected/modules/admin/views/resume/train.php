...
<div class="tab">
    ...
    <a  class="on" href="javascript:;">培训经历</a>
...
<div class="resume_list">
    <?php foreach ($allModel as $v): ?>
        <table class="items table table-bordered">
            ...
            <tbody>
                <tr>
                    <td><?php echo date('Y-m',$v->from_time) ?>---<?php echo date('Y-m',$v->to_time) ?></td><td><a href="<?php echo $this->createUrl('train', array('id' => $id, 'train_id' => $v->id)) ?>">修改</a></td>
                </tr>
            </tbody>
        </table>
    <?php endforeach ?>
        ...
        <table>
            ...
            <tbody class="full-time">
                ...
                <tr <?php if (array_key_exists('organization_name', $resume_log_content)): ?> class="<?php echo $resume_log_content['organization_name']['color'] ?>" <?php endif ?>>
                    <td>机构名称：</td>
                    <td class="other_weal">
                        <?php echo $form->textField($model, 'organization_name') ?>
                    </td>
                </tr>
