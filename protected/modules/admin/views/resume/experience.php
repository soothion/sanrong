...
<div class="tab">
    ...
    <a href="<?php echo $this->createUrl('/admin/resume/purpose', array('id' => $id)); ?>">求职意向</a>
    ...
    <a  class="on" href="javascript:;">工作经验</a>
...
<div class="resume_list">
    <?php foreach ($allModel as $v): ?>
        <table class="items table table-bordered">
            ...
            <tbody>
                <tr>
                    <td><?php echo date('Y-m',$v->from_time) ?>---<?php echo date('Y-m',$v->to_time) ?></td><td><a href="<?php echo $this->createUrl('experience', array('id' => $id, 'experience_id' => $v->id)) ?>">修改</a></td>
                </tr>
            </tbody>
        </table>
    <?php endforeach ?>
        ...
        <table>
            ...
            <tbody class="full-time">
                ...
                <tr <?php if (array_key_exists('company_name', $resume_log_content)): ?> class="<?php echo $resume_log_content['company_name']['color'] ?>" <?php endif ?>>
                    <td>工作单位：</td>
                    <td class="other_weal">
                        <?php echo $form->textField($model, 'company_name') ?>
                    </td>
                </tr>
                <tr <?php if (array_key_exists('position', $resume_log_content)): ?> class="<?php echo $resume_log_content['position']['color'] ?>" <?php endif ?>>
                    <td>所任职位：</td>
                    <td>
                        <?php echo $form->textField($model, 'position') ?>
                    </td>
                </tr>
                <tr <?php if (array_key_exists('business_card', $resume_log_content)): ?> class="<?php echo $resume_log_content['business_card']['color'] ?>" <?php endif ?>>
                    <td>上传名片：</td>
                    <td>
                        <input type="file" name="business_card" id="" />（zip包）<?php if (isset($model->business_card) && !empty($model->business_card)): ?><a href="<?php echo $model->business_card ?>">下载</a><?php endif; ?>
                    </td>
                </tr>
                <tr <?php if (array_key_exists('work_highlight', $resume_log_content)): ?> class="<?php echo $resume_log_content['work_highlight']['color'] ?>" <?php endif ?>>
                    <td>工作亮点：</td>
                    <td>
                        <?php echo $form->textArea($model, 'work_highlight') ?>
                    </td>
                </tr>
            </tbody>
            <?php else: ?>
