<style>
    ...
    <div class="">
            ...
            <input type="hidden" name="GrouponSubjectModel[pid]" value="<?php echo $model->pid ?>" />
            <?php echo $form->textFieldRow($model, 'name', array('class' => 'input-large')); ?>
            <?php echo $form->radioButtonListInlineRow($model, 'is_hot', GrouponSubjectModel::model()->is_hot_data()); ?>
