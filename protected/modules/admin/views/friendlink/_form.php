...
<?php echo $form->textFieldRow($model, 'url',array('placeholder'=>"不用写http://")) ?>
<?php echo $form->radioButtonListInlineRow($model, 'status', FriendlinkModel::model()->getStatus()) ?>
<?php echo $form->radioButtonListInlineRow($model, 'is_target', FriendlinkModel::model()->getTarget()) ?>
...
//    UE.getEditor('FriendlinkModel_content', {
//        imagePath: "",
