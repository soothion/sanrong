<p>
 <a href="javascript:void();" onclick="delete_selected();" class="btn btn-primary btn-small">删除</a>
  <a href="<?php echo $this->createUrl('virtual_enterprise_create'); ?>" class="btn btn-small">添加虚拟企业</a>
</p>
<!--<Br/>
...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'buttons' => array(
                'update' => array('label' => '修改', 'icon' => 'icon-pencil', 'url' => 'Yii::app()->controller->createUrl("virtual_enterprise_update",array("id"=>$data->primaryKey))'),
                'delete' => array('label' => '删除', 'icon' => 'icon-trash', 'url' => 'Yii::app()->controller->createUrl("virtual_enterprise_delete",array("id"=>$data->primaryKey))'),
