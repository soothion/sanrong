<p>
 <a href="javascript:void();" onclick="delete_selected();" class="btn btn-primary btn-small">删除</a>
  <a href="<?php echo $this->createUrl('create'); ?>" class="btn btn-small">添加广告</a>
</p>
<!--<Br/>
...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array('name' => 'type','value'=>'AdvertModel::model()->getType($data->type)'),
        array('name' => 'status','value'=>'AdvertModel::model()->getStatus($data->status)'),
