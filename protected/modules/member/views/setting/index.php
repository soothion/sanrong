    ...
    <div class="wrap"> 
        ...
        <div class="u_main fl">
            ...
            $form = $this->beginWidget('CActiveForm', array(
                'id' => 'id-form',
                'action' => $this->createUrl('info_save'),
            ...
            <?php endif; ?>
            <ul class="jl_xq">
                <li><b>手机号</b><input type="text" name='UserModel[mobile]' value="<?php echo $userModel->mobile ?>" /></li>
                <li><b>Email</b><input type="text" disabled="disabled" value="<?php echo $userModel->email ?>" /></li>
                <li><b>昵称</b><?php echo $form->textField($model, 'nickname') ?></li>
