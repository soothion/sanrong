    ...
    <div class='wrap'>
        <div class="u_main fl">
                ...
                <?php foreach ($All_model as $k => $v): ?>
                    <table class="order_list module_table">
                        <tr>
                            ...
                            <th style="width:91%;">操作</th>
                        </tr>
                        <tr>
                            <td style="text-align:left;"><span><?php echo date('Y-m', $v->from_time) ?>-<?php echo date('Y-m', $v->to_time) ?></span><span><?php echo $v->school ?></span><span><?php echo $v->major ?></span></td>
                            <td><a href="<?php echo $this->createUrl('education_update', array('id' => $v->id)) ?>" class="evaluate_btn evaluate_edit">修改</a></td>
                        </tr>
            ...
            <ul class="jl_xq">
                ...
                <li><b>所在院校</b><?php echo $form->textField($model, 'school') ?></li>
                <li><b>所学专业</b><?php echo $form->textField($model, 'major') ?></li>
