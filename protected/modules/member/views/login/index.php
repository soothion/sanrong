<div class='main'>
    <div class="wrap">
        <div class="login">
            <div class="login_nav">
                <div class="con"><span>会员登录</span></div>
            </div>
            <div class="login_m">
                <div class="login_l fl">
                    ...
                    <ul>
                        <li>
                            <em>账号：</em><?php echo $form->textField($model, 'email', array('placeholder' => '账户')); ?><?php echo $form->error($model, 'email',array('class '=>'login_error')); ?>
                        </li>
                        <li>
                            <em>密码：</em><?php echo $form->passwordField($model, 'password', array('placeholder' => '密码')); ?><span><a href="<?php echo $this->createUrl('/user/forget_pwd'); ?>">忘记密码？</a></span><?php echo $form->error($model, 'password',array('class'=>'login_error')); ?>
                        </li>
                        <li>
                ...
                <div class="login_r fr">
                    <p>尚未注册？</p>
                    <p><a href="<?php echo $this->createUrl('/member/register') ?>" class="side_reg_btn">立即注册</a></p>
                </div>
                <div class="clear"></div>
            </div>
        </div>
